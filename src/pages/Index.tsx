...
import { Download, ExternalLink, Github, Layers, Linkedin, Mail, MapPin, Mic, Moon, Phone, Send, Square, Sun, X } from "lucide-react";
...
const GithubContributions = ({ username = "SumanMadipeddi" }: { username?: string }) => {
      ...
      <div className="flex-grow flex flex-col justify-between">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div className="card-tag" style={{ marginBottom: 0 }}>Github activity</div>
          </div>
